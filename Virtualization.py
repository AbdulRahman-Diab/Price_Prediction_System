...
df_train: DataFrame = pd.read_csv("train.tsv", sep='\t')
df_test: DataFrame = pd.read_csv("test.tsv", sep='\t')
...
plt.title('BoxPlot price X Main product category', fontsize=5)
plt.xlabel('Main Category', fontsize=5)
...
plt.title('ASCENDING - 3rd level categories sorted by its mean prices', fontsize=5)
plt.xlabel('Price', fontsize=5)
plt.ylabel('3rd level categorie', fontsize=5)
...
plt.yticks(range(0,len(df)), df.index, fontsize=5)
plt.xticks(fontsize=5)
plt.title('DESCENDING - 3rd level categories sorted by its mean prices', fontsize=5)
plt.xlabel('Price', fontsize=5)
plt.ylabel('3rd level categorie', fontsize=5)
plt.legend(fontsize=5)
plt.show()
...
plt.yticks(range(0,len(df)), df.index, fontsize=5)
plt.xticks(fontsize=5)
plt.title('ASCENDING - 2nd level categories sorted by its mean prices', fontsize=5)
plt.xlabel('Price', fontsize=5)
plt.ylabel('3rd level categorie', fontsize=5)
plt.legend(fontsize=5)
plt.show()
...
plt.yticks(range(0,len(df)), df.index, fontsize=5)
plt.xticks(fontsize=5)
plt.title('DESCENDING - 2nd level categories sorted by its mean prices', fontsize=5)
plt.xlabel('Price', fontsize=5)
plt.ylabel('3rd level categorie', fontsize=5)
plt.legend(fontsize=5)
plt.show()
